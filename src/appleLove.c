...
#define MY_UUID {0x11, 0xDA, 0x4A, 0x00, 0x1E, 0x18, 0x4F, 0xEF, 0xA7, 0xE4, 0x2A, 0xCE, 0x52, 0x2F, 0xAA, 0xA7}
PBL_APP_INFO(MY_UUID, "Apple Love", "mApps", 0x1, 0x0, RESOURCE_ID_IMAGE_MENU_ICON, APP_INFO_WATCH_FACE);
...
void handle_init(AppContextRef ctx) {
  ...
  window_init(&window, "Apple Love Watch");
